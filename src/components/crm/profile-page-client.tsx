...
function DetailRow({
  ...
  return (
    <div className="flex gap-3 rounded-xl border border-white/[0.06] bg-[color-mix(in_oklab,var(--card)_72%,transparent)] px-4 py-3 shadow-[inset_0_1px_0_0_rgb(255_255_255/0.04)]">
...
export function ProfilePageClient() {
  ...
  return (
    <div className="mx-auto max-w-xl space-y-6">
      <div
        className={cn(
          "relative overflow-hidden rounded-2xl border border-white/[0.08] bg-[color-mix(in_oklab,var(--card)_78%,transparent)] p-6 shadow-[inset_0_1px_0_0_rgb(255_255_255/0.05)] sm:p-8",
        )}
      >
        <div
          className="pointer-events-none absolute -top-24 left-1/2 h-48 w-[min(100%,28rem)] -translate-x-1/2 rounded-full bg-primary/[0.12] blur-3xl"
          aria-hidden
        />
        <div className="relative flex flex-col items-center gap-5 text-center sm:flex-row sm:items-start sm:text-left">
          ...
          <div className="min-w-0 flex-1 space-y-2">
            <div className="inline-flex items-center gap-1.5 rounded-full border border-primary/25 bg-primary/[0.10] px-2.5 py-1 text-[11px] font-semibold tracking-wide text-primary uppercase">
