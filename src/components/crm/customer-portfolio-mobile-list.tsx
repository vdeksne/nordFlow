  ...
  return (
    <div className="space-y-3 md:hidden">
      <p className="text-muted-foreground flex items-center gap-2 px-0.5 text-[11px] leading-snug">
        <span className="bg-primary/15 text-primary rounded-full px-2 py-0.5 font-semibold tracking-wide uppercase">
          Mobile
        </span>
          ...
          return (
            <li key={row.id}>
              <button
                ...
                className={cn(
                  "border-sidebar-border flex w-full min-h-[4.5rem] touch-manipulation flex-col gap-2 rounded-2xl border border-white/[0.07] bg-[color-mix(in_oklab,var(--card)_92%,transparent)] p-4 text-left shadow-[inset_0_1px_0_0_rgb(255_255_255/0.04)] backdrop-blur-md transition-[transform,box-shadow,border-color] active:scale-[0.99]",
                  ...
                  isSelected &&
                    "border-primary/35 bg-primary/[0.08] shadow-[0_0_0_1px_color-mix(in_oklab,var(--primary)_35%,transparent)]",
                )}
