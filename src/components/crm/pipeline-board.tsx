    ...
    >
      <svg className="-rotate-90 size-full" viewBox="0 0 40 40">
        ...
        <circle
          ...
          style={{ filter: "drop-shadow(0 0 6px color-mix(in oklab, var(--primary) 55%, transparent))" }}
        />
      </svg>
...
function DealCard({ deal, stage }: { deal: Deal; stage: DealStage }) {
  return (
    <article className="group relative rounded-2xl">
      ...
      <div
        className={cn(
          "relative z-[1] overflow-hidden rounded-2xl border border-white/[0.06] bg-[color-mix(in_oklab,var(--card)_88%,transparent)] p-4 backdrop-blur-md",
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="relative overflow-x-auto pb-3 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <div
          className="pipeline-flow-beam pointer-events-none absolute top-[18px] right-8 left-8 z-0 h-px md:left-12 md:right-12"
          aria-hidden
        />
            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-3">
                {column.items.length === 0 ? (
                  <div className="border-sidebar-border text-muted-foreground/70 flex min-h-[120px] flex-col items-center justify-center rounded-2xl border border-dashed border-white/[0.07] bg-white/[0.02] px-4 py-8 text-center text-xs leading-relaxed">
                    <span className="mb-2 inline-flex size-8 items-center justify-center rounded-full border border-white/[0.06] text-lg font-light text-muted-foreground">
                      +
                    </span>
