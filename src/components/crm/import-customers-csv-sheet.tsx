        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 px-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              type="file"
              accept=".csv,text/csv"
              className="text-muted-foreground block w-full text-sm file:mr-3 file:rounded-md file:border-0 file:bg-muted file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-foreground hover:file:bg-muted/80"
              onChange={(e) => {
