...
function TaskCard({
  ...
  return (
    <article className="group relative rounded-2xl">
      <div
        className="pointer-events-none absolute -inset-px z-0 overflow-hidden rounded-2xl opacity-0 transition-opacity duration-500 group-hover:opacity-100"
        aria-hidden
      >
        <div className="pipeline-deal-aurora absolute -top-[85%] left-1/2 h-[240%] w-[240%] -translate-x-1/2 blur-2xl" />
      </div>
      <div
        className={cn(
          "relative z-[1] cursor-pointer overflow-hidden rounded-2xl border border-white/[0.06] bg-[color-mix(in_oklab,var(--card)_88%,transparent)] p-4 backdrop-blur-md outline-none",
          "shadow-[inset_0_1px_0_0_rgb(255_255_255/0.04)] transition-[border-color,box-shadow,transform] duration-300 ease-out",
          "group-hover:border-white/[0.11] group-hover:shadow-[0_24px_56px_-32px_color-mix(in_oklab,var(--primary)_48%,transparent)]",
      ...
      >
        ...
        <div className="relative flex gap-3">
          <button
            ...
            className={cn(
              "group/check mt-0.5 flex size-9 shrink-0 items-center justify-center rounded-xl border transition-all duration-300",
              task.done
                ? "border-primary/50 bg-primary/[0.18] text-primary shadow-[0_0_20px_-8px_color-mix(in_oklab,var(--primary)_60%,transparent)]"
...
function EmptyLane({ label }: { label: string }) {
  return (
    <div className="border-sidebar-border text-muted-foreground/70 flex min-h-[100px] flex-col items-center justify-center rounded-2xl border border-dashed border-white/[0.07] bg-white/[0.02] px-4 py-10 text-center text-[11px] leading-relaxed tracking-wide">
      <span className="mb-2 inline-flex size-8 items-center justify-center rounded-full border border-white/[0.06] text-lg font-light">
        ○
      </span>
      {label}
    </div>
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="relative overflow-x-auto pb-2 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <div
          className="pipeline-flow-beam pointer-events-none absolute top-[14px] right-10 left-10 z-0 h-px md:left-16 md:right-16"
          aria-hidden
        />
            ...
            >
              <div
                className={cn(
                  ...
                  node.hot
                    ? "pipeline-node-hot border-primary/45 bg-primary/[0.14] text-primary"
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_260px] lg:gap-10">
        ...
        <aside className="space-y-4 lg:sticky lg:top-28 lg:self-start">
          <div
            className={cn(
              "overflow-hidden rounded-2xl border border-white/[0.06] bg-[color-mix(in_oklab,var(--card)_82%,transparent)] p-5 backdrop-blur-md",
