      ...
      <div className="rounded-none border border-white/[0.08] bg-[color-mix(in_oklab,var(--card)_88%,transparent)] p-8 shadow-[0_32px_90px_-52px_color-mix(in_oklab,var(--primary)_45%,transparent)] backdrop-blur-xl sm:p-9">
        ...
        {phase === "preview" ? (
          <div className="mt-8 space-y-4">
            <div className="rounded-none border border-emerald-400/20 bg-emerald-500/[0.07] px-4 py-3 text-sm leading-relaxed text-foreground">
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                type="button"
                variant="secondary"
                className="h-11 border-white/[0.1] normal-case tracking-normal text-[13px] font-normal"
