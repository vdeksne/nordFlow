...
export function TopBarProfileLink({ className }: { className?: string }) {
  ...
  return (
    <Link
      ...
      className={cn(
        "focus-visible:ring-primary shrink-0 rounded-none outline-none transition-opacity hover:opacity-95 active:opacity-90 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background",
        className,
      )}
    >
