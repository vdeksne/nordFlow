  ...
  return (
    ...
    >
      <CardHeader className="flex flex-row items-start justify-between gap-3 pb-2">
        ...
        <span className="bg-primary/[0.12] text-primary ring-white/[0.08] inline-flex size-10 items-center justify-center rounded-full ring-1">
      ...
      <CardContent className="space-y-1">
        ...
        {trend ? (
          <p
            className={cn(
              "text-xs font-medium",
              trend.positive === false ? "text-destructive" : "text-primary",
            )}
          >
            {trend.label}
          </p>
